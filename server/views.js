...
// LOGIN PAGE
// ─────────────────────────────────────────────
function renderFocusedLoginPage(errorMsg = null) {
  const initialError = JSON.stringify(errorMsg || '');
  return `<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#111114"><title>Giriş yap — EkoYıldız</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Manrope:wght@600;700;800&display=swap" rel="stylesheet"><style>
  :root{--ink:#17171b;--muted:#686a74;--line:#e5e5ea;--soft:#f7f7f8;--pink:#ed6b88;--violet:#635bdf}*{box-sizing:border-box}body{margin:0;background:#fff;color:var(--ink);font:16px 'DM Sans',sans-serif}.page{min-height:100vh;display:grid;grid-template-columns:1fr 1fr}.context{background:#18181d;color:#fff;padding:42px clamp(30px,7vw,100px);display:flex;flex-direction:column;justify-content:space-between}.brand{font:800 1.2rem Manrope;text-decoration:none;color:#fff;letter-spacing:-.06em}.brand i{font-style:normal;color:#f490aa}.context-main{max-width:510px;padding:78px 0}.eyebrow{color:#f6a1b6;font-weight:800;letter-spacing:.13em;font-size:.73rem}.context h1{font:800 clamp(2.9rem,5vw,5rem)/.99 Manrope;letter-spacing:-.075em;margin:17px 0 21px}.context p{max-width:470px;color:#c0c0c8;line-height:1.65}.steps{margin-top:38px;border-top:1px solid #414149}.step{display:flex;gap:14px;padding:15px 0;border-bottom:1px solid #414149}.step b{display:block;font-size:.92rem}.step span{color:#b7b7c1;font-size:.84rem;line-height:1.45}.step-no{color:#f5a0b5;font:800 .85rem Manrope}.context-foot{font-size:.8rem;color:#aaaab4}.context-foot a{color:#fff}.auth{width:min(510px,100% - 48px);margin:auto;padding:38px 0}.auth-top{display:flex;justify-content:space-between;align-items:center;margin-bottom:62px}.auth-top a{color:var(--muted);font-size:.86rem;font-weight:700;text-decoration:none}.auth-top a:hover{color:var(--ink)}.auth h2{font:800 2.25rem/1 Manrope;letter-spacing:-.065em;margin:0 0 12px}.sub{margin:0;color:var(--muted);line-height:1.6}.alert{display:none;margin:20px 0;padding:12px 14px;border:1px solid #f5bbca;background:#fff5f7;color:#9e3151;border-radius:10px;font-size:.86rem}.method-list{display:grid;gap:10px;margin-top:29px}.method{width:100%;appearance:none;background:#fff;border:1px solid var(--line);border-radius:12px;padding:16px;text-align:left;color:var(--ink);cursor:pointer;font:inherit;display:flex;align-items:center;gap:13px;text-decoration:none}.method:hover{border-color:#9f99ec;background:#fbfaff}.method-icon{width:38px;height:38px;border-radius:10px;display:grid;place-items:center;background:var(--soft);font-size:1.1rem}.method-copy{display:flex;flex-direction:column;gap:3px;flex:1}.method-copy b{font-size:.94rem}.method-copy small{color:var(--muted);font-size:.78rem}.method-arrow{color:#9a9aa3}.split{display:flex;align-items:center;gap:12px;color:#9a9aa3;font-size:.75rem;margin:24px 0}.split:before,.split:after{content:'';height:1px;background:var(--line);flex:1}.secondary-row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.secondary{border:1px solid var(--line);background:#fff;border-radius:10px;min-height:49px;color:var(--ink);font:700 .84rem 'DM Sans';cursor:pointer}.secondary:hover{background:var(--soft)}.security{margin-top:27px;padding:15px;border-radius:11px;background:var(--soft);font-size:.79rem;color:var(--muted);line-height:1.5}.security b{display:block;color:var(--ink);margin-bottom:3px}.security a{color:#5149c9;font-weight:700}.view{display:none}.view.active{display:block}.view h3{font:800 1.55rem/1.1 Manrope;letter-spacing:-.05em;margin:0 0 10px}.back{border:0;background:none;padding:0;color:var(--muted);font:700 .83rem 'DM Sans';cursor:pointer;margin-bottom:25px}.back:hover{color:var(--ink)}.option-note{border-left:3px solid var(--violet);background:#f8f7ff;padding:13px 14px;color:#55526d;font-size:.84rem;line-height:1.55;margin:19px 0}.option-note a{color:#5149c9;font-weight:800}.field{margin:16px 0}.field label{display:block;font-size:.8rem;font-weight:800;margin:0 0 7px}.field input{width:100%;border:1px solid var(--line);padding:13px;border-radius:9px;font:inherit;outline:0}.field input:focus{border-color:var(--violet);box-shadow:0 0 0 3px #eeedff}.primary{border:0;background:#1b1b20;color:#fff;border-radius:10px;padding:14px 17px;width:100%;font:800 .9rem 'DM Sans';cursor:pointer;margin-top:4px}.primary:hover{background:var(--violet)}.linkline{margin:18px 0 0;text-align:center;font-size:.82rem;color:var(--muted)}.linkline a{font-weight:800;color:#5149c9}.progress{display:flex;gap:5px;margin:0 0 25px}.progress i{height:4px;flex:1;border-radius:4px;background:var(--line)}.progress i.on{background:var(--violet)}.choice{display:flex;gap:9px;align-items:flex-start;margin:18px 0;color:var(--muted);font-size:.82rem;line-height:1.45}.choice input{accent-color:var(--violet)}@media(max-width:820px){.page{grid-template-columns:1fr}.context{min-height:260px;padding:28px}.context-main{padding:35px 0 0}.context h1{font-size:2.6rem}.context .steps{display:none}.context-foot{display:none}.auth{padding:38px 0}.auth-top{margin-bottom:40px}}@media(max-width:430px){.auth{width:min(100% - 30px,510px)}.secondary-row{grid-template-columns:1fr}.context h1{font-size:2.3rem}}
  </style></head><body><div class="page"><aside class="context"><a class="brand" href="/">eko<i>yıldız</i></a><div class="context-main"><div class="eyebrow">RESMÎ HESAP PORTALI</div><h1>Topluluğa güvenle bağlan.</h1><p>Discord, Roblox ve site hesabın için neyi neden kullandığını açıkça anlatan giriş deneyimi.</p><div class="steps"><div class="step"><div class="step-no">01</div><div><b>Yöntemini seç</b><span>Discord en hızlı başlangıçtır; Roblox ise hesabını bağlamak içindir.</span></div></div><div class="step"><div class="step-no">02</div><div><b>Resmî ekranda doğrula</b><span>Parolanı, tokenını veya özel kodunu EkoYıldız ekibi asla istemez.</span></div></div><div class="step"><div class="step-no">03</div><div><b>Paneline devam et</b><span>Bağlantılarını ve destek seçeneklerini panelden yönetebilirsin.</span></div></div></div></div><div class="context-foot">Bir sorun mu var? <a href="/yardim">Safety Center’ı aç</a></div></aside><main class="auth"><div class="auth-top"><a href="/">← Ana sayfa</a><a href="/yardim">Yardıma ihtiyacın var mı?</a></div><div class="view active" id="login-main"><h2>Giriş yap</h2><p class="sub">Devam etmek için bir yöntem seç. Her seçeneğin nasıl çalıştığını da anlatıyoruz.</p><div class="alert" id="auth-error"></div><div class="method-list"><a class="method" href="/auth/discord"><span class="method-icon" style="background:#eef0ff;color:#5865f2">◉</span><span class="method-copy"><b>Discord ile devam et</b><small>Önerilen · Resmî Discord OAuth doğrulaması</small></span><span class="method-arrow">→</span></a><button class="method" data-view="discord-code"><span class="method-icon">✉</span><span class="method-copy"><b>Discord DM kodu ile giriş</b><small>Discord’a kısa süreli doğrulama kodu gönder</small></span><span class="method-arrow">→</span></button><a class="method" href="/auth/roblox"><span class="method-icon">◆</span><span class="method-copy"><b>Roblox hesabını bağla</b><small>OAuth ile hesabını güvenli biçimde eşleştir</small></span><span class="method-arrow">→</span></a><button class="method" data-view="roblox-info"><span class="method-icon">🎮</span><span class="method-copy"><b>Roblox doğrulama seçenekleri</b><small>Arkadaş isteği veya profil açıklaması kodu</small></span><span class="method-arrow">→</span></button></div><div class="split">veya</div><div class="secondary-row"><button class="secondary" data-view="site-password">Site hesabıyla giriş</button><button class="secondary" data-view="register-one">Yeni hesap oluştur</button></div><div class="security"><b>🔒 Güvenlik notu</b>Giriş yöntemleri ve hesap bağlama hakkında daha fazlasını <a href="/blog/discord-ile-giris-nasil-calisir">Discord giriş rehberinde</a> ve <a href="/blog/roblox-hesabi-nasil-dogrulanir">Roblox doğrulama rehberinde</a> bulabilirsin.</div></div>
  <div class="view" id="discord-code"><button class="back" data-view="login-main">← Tüm giriş yöntemleri</button><h3>Discord’dan kod al</h3><p class="sub">Kullanıcı adı, görünen ad veya ID’ni yaz; Phibi/Sentara kısa süreli altı haneli kodu Discord DM’ine gönderir.</p><div class="option-note">Kodu hiç kimseyle paylaşma. <a href="/blog/discord-ile-giris-nasil-calisir">Bu yöntem nasıl çalışır?</a></div><div id="dm-start"><div class="field"><label>Discord kullanıcı adı, görünen ad veya ID</label><input id="dm-username" autocomplete="username" placeholder="ör. ekoyildiz veya 123456789012345678"></div><button class="primary" id="dm-request">Kodu gönder</button></div><div id="dm-verify" style="display:none"><div class="field"><label>DM’deki 6 haneli kod</label><input id="dm-code" inputmode="numeric" maxlength="6" placeholder="000000"></div><button class="primary" id="dm-confirm">Doğrula ve giriş yap</button></div></div>
  <div class="view" id="roblox-info"><button class="back" data-view="login-main">← Tüm giriş yöntemleri</button><h3>Roblox’u nasıl doğrulamak istersin?</h3><p class="sub">Şifre değil, sahiplik doğrulaması istenir. En hızlı yol OAuth’tur.</p><a class="method" style="margin-top:23px" href="/auth/roblox"><span class="method-icon">◆</span><span class="method-copy"><b>Roblox OAuth</b><small>Resmî Roblox izin ekranıyla bağla</small></span><span class="method-arrow">→</span></a><button class="method" data-view="register-one"><span class="method-icon">👥</span><span class="method-copy"><b>Arkadaş isteği ile doğrula</b><small>Önce portal hesabını oluştur, sonra yönergeleri izle</small></span><span class="method-arrow">→</span></button><button class="method" data-view="register-one"><span class="method-icon">📝</span><span class="method-copy"><b>Profil açıklaması kodu</b><small>Geçici kodu Roblox profilinde doğrula</small></span><span class="method-arrow">→</span></button><div class="security"><b>Roblox şifreni istemiyoruz.</b><a href="/blog/roblox-hesabi-nasil-dogrulanir">Tüm Roblox doğrulama yöntemlerini oku →</a></div></div>
  <div class="view" id="site-password"><button class="back" data-view="login-main">← Tüm giriş yöntemleri</button><h3>Site hesabınla giriş yap</h3><p class="sub">Bu yalnızca EkoYıldız portalı için oluşturduğun hesap şifresidir.</p><div class="field"><label>Kullanıcı adı</label><input id="site-user" autocomplete="username"></div><div class="field"><label>Site şifresi</label><input id="site-password-value" type="password" autocomplete="current-password"></div><button class="primary" id="site-login">Giriş yap</button><p class="linkline"><a href="/yardim">Şifremi unuttum / destek al</a></p></div>
  <div class="view" id="register-one"><button class="back" data-view="login-main">← Girişe dön</button><div class="progress"><i class="on"></i><i></i><i></i></div><h3>Hesabını oluştur</h3><p class="sub">İlk adım: herkesin göreceği kullanıcı adını seç.</p><div class="field"><label>Kullanıcı adı</label><input id="new-user" maxlength="32" autocomplete="username" placeholder="3–32 karakter"></div><button class="primary" id="register-next">Devam et</button></div>
  <div class="view" id="register-two"><button class="back" data-view="register-one">← Önceki adım</button><div class="progress"><i class="on"></i><i class="on"></i><i></i></div><h3>Güçlü bir şifre belirle</h3><p class="sub">En az 10 karakter; harf ve rakam içermeli.</p><div class="field"><label>Şifre</label><input id="new-password" type="password" autocomplete="new-password"></div><div class="field"><label>Şifreyi tekrar yaz</label><input id="new-password-again" type="password" autocomplete="new-password"></div><button class="primary" id="register-password-next">Devam et</button></div>
  <div class="view" id="register-three"><button class="back" data-view="register-two">← Önceki adım</button><div class="progress"><i class="on"></i><i class="on"></i><i class="on"></i></div><h3>Son güvenlik adımı</h3><p class="sub">Hesabın oluşturulduktan sonra Discord veya Roblox’u istediğin zaman bağlayabilirsin.</p><label class="choice"><input type="checkbox" id="register-consent"><span><a href="/legal/privacy">Veri işleme bilgilendirmesini</a> okudum ve hesap oluşturulması için gerekli verilerin işlenmesini kabul ediyorum.</span></label><button class="primary" id="register-finish">Hesabı oluştur</button><div class="security"><b>2FA önerilir.</b>Hesabın oluştuğunda güvenlik ayarlarından iki aşamalı doğrulamayı açabilirsin.</div></div></main></div><script>
  const serverError=${initialError};const state={username:'',password:''};const err=document.getElementById('auth-error');function showError(message){err.textContent='⚠️ '+message;err.style.display='block';window.scrollTo({top:0,behavior:'smooth'})}if(serverError)showError(serverError);function setView(id){document.querySelectorAll('.view').forEach(v=>v.classList.remove('active'));document.getElementById(id).classList.add('active');err.style.display='none';window.scrollTo({top:0,behavior:'smooth'})}document.querySelectorAll('[data-view]').forEach(el=>el.addEventListener('click',()=>setView(el.dataset.view)));
  document.getElementById('dm-request').addEventListener('click',async()=>{const username=document.getElementById('dm-username').value.trim();if(!username)return showError('Discord kullanıcı adı, görünen ad veya ID gerekli.');const btn=document.getElementById('dm-request');btn.disabled=true;btn.textContent='Kod gönderiliyor…';try{const r=await fetch('/auth/send-discord-dm-code',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username})});const d=await r.json();if(d.success){document.getElementById('dm-start').style.display='none';document.getElementById('dm-verify').style.display='block'}else showError(d.error||'Kod gönderilemedi.')}catch(e){showError('Bağlantı kurulamadı.')}btn.disabled=false;btn.textContent='Kodu gönder'});
  document.getElementById('dm-confirm').addEventListener('click',async()=>{const code=document.getElementById('dm-code').value.trim();if(code.length!==6)return showError('DM’deki 6 haneli kodu yaz.');try{const r=await fetch('/auth/verify-discord-dm-code',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({code})});const d=await r.json();if(d.success)location.href=d.redirectUrl||'/dashboard';else showError(d.error||'Kod doğrulanamadı.')}catch(e){showError('Bağlantı kurulamadı.') }});
  document.getElementById('site-login').addEventListener('click',async()=>{const username=document.getElementById('site-user').value.trim(),password=document.getElementById('site-password-value').value;if(!username||!password)return showError('Kullanıcı adı ve şifre gerekli.');try{const r=await fetch('/api/auth/site-login',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username,password,rememberMe:true})});const d=await r.json();if(d.success)location.href='/dashboard';else showError(d.error||'Giriş yapılamadı.')}catch(e){showError('Bağlantı kurulamadı.') }});
  document.getElementById('register-next').addEventListener('click',()=>{const username=document.getElementById('new-user').value.trim();if(!/^[a-zA-Z0-9_.-]{3,32}$/.test(username))return showError('Kullanıcı adı 3–32 karakter olmalı; yalnızca harf, rakam, _, . ve - kullanabilirsin.');state.username=username;setView('register-two')});document.getElementById('register-password-next').addEventListener('click',()=>{const p=document.getElementById('new-password').value,a=document.getElementById('new-password-again').value;if(p.length<10||!/[a-z]/i.test(p)||!/\d/.test(p))return showError('Şifre en az 10 karakter olmalı; harf ve rakam içermeli.');if(p!==a)return showError('Şifreler aynı değil.');state.password=p;setView('register-three')});document.getElementById('register-finish').addEventListener('click',async()=>{if(!document.getElementById('register-consent').checked)return showError('Devam etmek için veri işleme bilgilendirmesini onayla.');const btn=document.getElementById('register-finish');btn.disabled=true;btn.textContent='Hesap oluşturuluyor…';try{const r=await fetch('/api/auth/register-interactive',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username:state.username,password:state.password,enable2FA:false,consentVersion:'portal-data-v1'})});const d=await r.json();if(d.success)location.href=d.redirectUrl||'/dashboard';else showError(d.error||'Hesap oluşturulamadı.')}catch(e){showError('Bağlantı kurulamadı.')}btn.disabled=false;btn.textContent='Hesabı oluştur'});try{const p=new URLSearchParams(location.search),suggested=p.get('username');if(suggested)document.getElementById('new-user').value=suggested;if(p.get('register')==='1'||suggested)setView('register-one')}catch(e){}
  </script></body></html>`;
}

function renderLoginPage(errorMsg = null) {
  return renderFocusedLoginPage(errorMsg);
...
function renderDashboard(user, staffProgress) {
  ...
  const staffState = (user.isStaff || isSiteAdmin(user)) && !staffProgress
    ? 'Personel kaydı henüz yüklenmedi. Araçlarına erişebilir, kayıt eşleşmesini Staff Center’dan kontrol edebilirsin.'
    : 'Hesap ve bağlantı durumuna göre önemli yollar burada gösteriliyor.';
  const focusedContent = `
    <section class="focused-dashboard">
      <div class="focused-heading"><div><p class="focused-label">HESABIN</p><h1>İyi günler, ${displayName}.</h1><p class="focused-copy">${staffState}</p></div><div class="focused-account"><strong>${role}</strong><span>${connectionSummary.join(' · ')}</span><a href="/settings">Hesap ayarları</a></div></div>
      <div class="focus-priority"><div><span>BEKLEYEN İŞLEMLER</span><strong>${isRobloxLinked ? 'Bağlantıların güncel görünüyor' : 'Roblox bağlantısı tamamlanabilir'}</strong><p>${isRobloxLinked ? 'Yeni bir işlem gerektiğinde burada göreceksin.' : 'Rol eşleştirme ve bazı araçlar için hesabını bağlayabilirsin.'}</p></div><nav aria-label="Hızlı işlemler"><b>Hızlı işlemler</b><a href="/tickets/new">Ticket aç</a><a href="/help">Help Center</a><a href="/safety">Safety Center</a></nav></div>
      <div class="focus-grid">
        ...
        <a class="focus-card" href="/help"><span>HELP CENTER</span><h2>Önce hızlıca bak</h2><p>Hesap, bot, panel ve destek rehberleri burada.</p><b>Help Center'ı aç →</b></a>
  ...
  const focusedCss = `<style>
    .focused-dashboard{max-width:1040px;margin:28px auto 48px}.focused-heading{display:flex;justify-content:space-between;gap:24px;align-items:flex-end;padding:42px 0;border-bottom:1px solid rgba(255,255,255,.12)}.focused-label,.focus-card span,.focus-priority span{font-size:.72rem;letter-spacing:.12em;font-weight:800;color:#fda4af;margin:0 0 12px}.focused-heading h1{font-size:clamp(2.25rem,5vw,4.3rem);letter-spacing:-.065em;line-height:1;margin:0}.focused-copy{color:var(--muted);margin:15px 0 0;max-width:530px;line-height:1.55}.focused-account{min-width:220px;border-left:1px solid rgba(255,255,255,.12);padding-left:22px;display:flex;flex-direction:column;gap:7px}.focused-account strong{font-size:.94rem}.focused-account span{color:var(--muted);font-size:.82rem;line-height:1.45}.focused-account a,.focus-card b{font-size:.84rem;color:#fff;text-decoration:underline;text-underline-offset:4px;margin-top:7px}.focus-priority{display:grid;grid-template-columns:1fr auto;gap:24px;align-items:center;margin-top:28px;padding:20px 22px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:#101014}.focus-priority strong{display:block;margin:3px 0 6px}.focus-priority p{margin:0;color:var(--muted);font-size:.84rem}.focus-priority nav{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.focus-priority nav b{font-size:.78rem;color:var(--muted);margin-right:4px}.focus-priority nav a{padding:8px 10px;border:1px solid rgba(255,255,255,.12);border-radius:8px;color:#fff;text-decoration:none;font-size:.78rem;font-weight:750}.focus-grid{display:grid;grid-template-columns:repeat(2,1fr);border:1px solid rgba(255,255,255,.12);border-radius:16px;overflow:hidden;margin-top:18px}.focus-card{min-height:235px;padding:30px;display:flex;flex-direction:column;align-items:flex-start;border-right:1px solid rgba(255,255,255,.12);border-bottom:1px solid rgba(255,255,255,.12);color:inherit;text-decoration:none;background:#101014;transition:background .18s}.focus-card:nth-child(2n){border-right:0}.focus-card:nth-last-child(-n+2){border-bottom:0}.focus-card:hover{background:#18181d}.focus-card h2{font-size:1.45rem;letter-spacing:-.045em;margin:0}.focus-card p{font-size:.92rem;line-height:1.55;color:var(--muted);max-width:330px;margin:12px 0}.focus-card b{margin-top:auto}.focus-card-featured{background:#ee6a88;color:#1a1114}.focus-card-featured span,.focus-card-featured p,.focus-card-featured b{color:#1a1114}@media(max-width:720px){.focused-dashboard{margin-top:8px}.focused-heading{align-items:flex-start;flex-direction:column;padding:30px 0}.focused-account{border-left:0;border-top:1px solid rgba(255,255,255,.12);padding:16px 0 0;width:100%}.focus-priority{grid-template-columns:1fr}.focus-grid{grid-template-columns:1fr}.focus-card,.focus-card:nth-child(2n){border-right:0;border-bottom:1px solid rgba(255,255,255,.12)}.focus-card:last-child{border-bottom:0}}</style>`;
...
function renderProfilePage(user, profileUser, isOwn = false, robloxGroups = []) {
  return renderAdvancedProfilePage(user, profileUser, isOwn, robloxGroups, _layout);
}
