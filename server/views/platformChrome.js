...
function platformChromeStyles(theme = 'dark') {
  ...
  return `<style>
    ...
    .platform-header{box-sizing:border-box;width:min(1360px,calc(100% - 32px));min-height:64px;margin:14px auto 0;padding:8px 12px;display:grid;grid-template-columns:max-content minmax(0,1fr) max-content;align-items:center;gap:10px;position:sticky;top:12px;z-index:500;background:var(--pc-glass);border:1px solid var(--pc-line);border-radius:18px;box-shadow:0 16px 42px rgba(0,0,0,.13),inset 0 1px 0 var(--pc-glow);backdrop-filter:blur(22px) saturate(145%);-webkit-backdrop-filter:blur(22px) saturate(145%)}
    .platform-brand{min-width:0;display:flex;align-items:center;gap:9px;padding:0 5px;color:var(--pc-text);text-decoration:none;font-weight:850;letter-spacing:-.045em;white-space:nowrap;flex-shrink:0}.platform-brand img{width:35px;height:35px;flex:0 0 auto;border-radius:11px;box-shadow:0 3px 12px rgba(0,0,0,.13)}.platform-brand i{font-style:normal;color:#ed5b7b}
    .platform-nav{min-width:0;display:flex;align-items:center;justify-content:center;gap:3px;overflow-x:auto;overflow-y:visible;white-space:nowrap;scrollbar-width:none;-ms-overflow-style:none}.platform-nav::-webkit-scrollbar{display:none}
    .platform-nav a,.platform-nav button{flex-shrink:0;white-space:nowrap;min-width:max-content;min-height:38px;display:inline-flex;align-items:center;justify-content:center;border:1px solid transparent;border-radius:10px;padding:0 clamp(7px,1vw,11px);background:transparent;color:var(--pc-muted);font:700 clamp(.73rem,1.1vw,.84rem) inherit;text-decoration:none;cursor:pointer;transition:background-color .18s ease,color .18s ease,border-color .18s ease,box-shadow .18s ease}.platform-nav a:hover,.platform-nav button:hover{background:var(--pc-hover);color:var(--pc-text)}.platform-nav a[aria-current="page"]{background:var(--pc-hover);border-color:var(--pc-line);box-shadow:inset 0 1px 0 var(--pc-glow);color:var(--pc-text)}
    .platform-dropdown{position:relative;display:inline-flex;align-items:center;flex-shrink:0}
    .platform-dropdown-btn{min-height:38px;display:inline-flex;align-items:center;gap:4px;border:1px solid transparent;border-radius:10px;padding:0 clamp(7px,1vw,11px);background:transparent;color:var(--pc-muted);font:700 clamp(.73rem,1.1vw,.84rem) inherit;cursor:pointer;white-space:nowrap;transition:background-color .18s ease,color .18s ease,border-color .18s ease}
    ...
    .platform-dropdown-menu{position:absolute;top:calc(100% + 6px);left:50%;transform:translateX(-50%) translateY(4px);min-width:180px;padding:6px;background:var(--pc-bg);border:1px solid var(--pc-line);border-radius:14px;box-shadow:0 18px 48px rgba(0,0,0,.35),inset 0 1px 0 var(--pc-glow);backdrop-filter:blur(22px);-webkit-backdrop-filter:blur(22px);opacity:0;visibility:hidden;pointer-events:none;transition:opacity .18s ease,transform .18s ease,visibility .18s;z-index:650;display:flex;flex-direction:column;gap:3px}
    ...
    .platform-actions{min-width:0;display:flex;align-items:center;justify-content:flex-end;gap:7px;flex-shrink:0}.platform-search-trigger{flex:0 0 auto;min-height:38px;display:inline-flex;align-items:center;gap:7px;border:1px solid var(--pc-line)!important;border-radius:10px;padding:0 9px;background:rgba(127,127,140,.06)!important;color:var(--pc-muted);font:700 .78rem inherit;cursor:pointer;box-shadow:inset 0 1px 0 var(--pc-glow)}.platform-search-trigger:hover{background:var(--pc-hover)!important;color:var(--pc-text)}.platform-search-trigger kbd{font:750 .64rem inherit;border:1px solid var(--pc-line);border-radius:5px;padding:2px 4px;color:var(--pc-muted);background:rgba(127,127,140,.07)}
    .platform-account{min-width:0;display:flex;align-items:center;gap:2px}.platform-account a{min-width:0;min-height:38px;display:inline-flex;align-items:center;padding:0 9px;border-radius:10px;color:var(--pc-muted);font-weight:750;font-size:.78rem;text-decoration:none;transition:background-color .18s ease,color .18s ease;white-space:nowrap}.platform-account a:hover{background:var(--pc-hover);color:var(--pc-text)}.platform-account .platform-account-name{display:block;max-width:clamp(86px,10vw,148px);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.platform-account .platform-primary{padding:0 13px;background:var(--pc-text);color:var(--pc-bg);box-shadow:0 3px 12px rgba(0,0,0,.12)}
    .platform-menu-toggle{display:none;justify-self:end;width:40px;height:40px;border:1px solid var(--pc-line);border-radius:10px;background:var(--pc-hover);color:var(--pc-text);font-size:1.05rem;cursor:pointer;box-shadow:inset 0 1px 0 var(--pc-glow)}
