...
const { renderPlatformHeader, renderPlatformFooter, renderSearchDialog, platformChromeStyles, platformChromeScript } = require('../platformChrome');
...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; } body { margin:0; color:var(--ink); background:var(--paper); font-family:Inter,Arial,sans-serif; }
    ...
    .social-lede{display:flex;align-items:end;justify-content:space-between;gap:22px}.social-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.social-group{border:1px solid var(--line);border-radius:14px;padding:23px;background:#fff}.social-group h3{margin:10px 0 15px;font-size:1.1rem;letter-spacing:-.04em}.social-group small{color:var(--pink);font-weight:800;letter-spacing:.1em}.social-link{display:flex;align-items:center;justify-content:space-between;padding:10px 0;border-top:1px solid var(--line);font-size:.88rem;font-weight:700}.social-link span{color:var(--muted);font-weight:500}.social-link:hover{color:var(--pink)}.star-button{width:42px;height:42px;border:1px solid var(--line);border-radius:50%;background:#fff;color:var(--pink);cursor:pointer;font-size:1.15rem}.star-button:hover{transform:rotate(15deg);border-color:var(--pink)}.floating-star{position:fixed;z-index:999;pointer-events:none;color:var(--pink);font-size:20px;animation:star-float 900ms ease-out forwards}@keyframes star-float{to{transform:translate(var(--x),-95px) rotate(130deg);opacity:0}}
    footer { padding:30px 0 42px; color:#86868e; font-size:.8rem; display:flex; justify-content:space-between; }
    @media(max-width:760px) { .home-wrap{width:min(100% - 28px,1160px)} .home-links a:not(:last-child){display:none} .home-hero{grid-template-columns:1fr;gap:22px;padding:55px 0} .home-art{min-height:235px} .home-grid,.social-grid{grid-template-columns:1fr}.home-card{border-right:0;border-bottom:1px solid var(--line)}.home-card:last-child{border-bottom:0}.home-section-head,.home-join,footer{align-items:flex-start;flex-direction:column}.home-section-head{gap:12px} }
  </style>
</head>
<body>
  ${renderPlatformHeader({ user, activePath: '/', theme: 'light' })}
  <div class="home-wrap">
    <main>
      <section class="home-hero"><div><div class="home-eyebrow">EkoYıldız topluluğu</div><h1>İyi oyunlar, iyi insanlar.</h1><p class="home-intro">İçerikleri takip et, toplulukla buluş ve ihtiyacın olduğunda doğru yere tek adımda ulaş. Gereksiz karmaşa yok.</p><div class="home-actions"><a class="home-button home-button-dark" href="https://discord.gg/rEu5gvRBdM" target="_blank" rel="noreferrer">EkoYıldız Discord’a katıl</a><a class="home-button home-button-light" href="/video-blog">Video Blog’u aç</a></div><div class="home-note">${user ? `Tekrar hoş geldin, ${name}.` : 'Hesabın varsa panelden devam edebilirsin.'}</div></div><aside class="home-art"><span>Topluluk, içerik, destek</span><strong>Herkes için daha düzenli bir EkoYıldız.</strong></aside></section>
      <section class="home-section" style="padding-top:10px"><div class="home-section-head"><h2>Video Blog</h2><p>EkoYıldız’ın son YouTube seçkisi artık ana sayfada; videolara tek tıkla ulaş.</p></div><div class="home-grid"><article class="home-card"><small>YENİ VİDEO</small><h3>Kampların batmasının gerçek sebebi</h3><p>Nasıl Kamp Kurulur serisinin son bölümünü izle.</p><a href="/video-blog">Video Blog’u aç</a></article><article class="home-card"><small>EKOCAST</small><h3>Topluluğun gündemi</h3><p>Röportajlar, hikâyeler ve EkoYıldız videoları tek listede.</p><a href="/video-blog">Tüm videolar</a></article><article class="home-card"><small>RESMÎ KANAL</small><h3>@eko8yildiz</h3><p>Yeni video yayınlandığında ilk haberdar olmak için kanalı takip et.</p><a href="https://www.youtube.com/@eko8yildiz" target="_blank" rel="noreferrer">YouTube’u aç ↗</a></article></div></section>
      <section class="home-section"><div class="home-section-head"><h2>Neye ihtiyacın var?</h2><p>Sayfaları yalnızca işe yarayan şeyler etrafında topladık.</p></div><div class="home-grid"><article class="home-card"><small>01 / İÇERİK</small><h3>Yeni şeyleri keşfet</h3><p>Çekilişler, duyurular ve toplulukta olan bitenler tek yerde.</p><a href="/cekilisler">Çekilişlere git</a></article><article class="home-card"><small>02 / DESTEK</small><h3>Doğru kişiye ulaş</h3><p>Hesap, bot, panel ve ticket sorunları için net yardım yolları.</p><a href="/help">Help Center’ı aç</a><br><a href="/safety">Güvenlik konusuysa Safety Center →</a></article><article class="home-card"><small>03 / PERSONEL</small><h3>Personel sistemi nasıl çalışır?</h3><p>Alım, nöbet, geri bildirim ve ekipte gelişim sürecini incele.</p><a href="/blog/personel-sistemi-nasil-calisir">Rehberi oku</a></article></div></section>
      ...
      <section class="home-section"><div class="home-section-head social-lede"><div><h2>EkoYıldız Resmî Hesapları</h2><p>Yeni yayınları, videoları ve paylaşımları doğrudan resmî hesaplardan takip et.</p></div><button class="star-button" id="star-button" aria-label="Küçük bir sürpriz">✦</button></div><div class="social-grid"><article class="social-group"><small>🎮 CANLI YAYINLAR</small><h3>Yayında buluşalım</h3><a class="social-link" href="https://kick.com/ekoyildiz" target="_blank" rel="noreferrer"><span>Kick</span> @ekoyildiz ↗</a><a class="social-link" href="https://www.twitch.tv/ekoyildiz" target="_blank" rel="noreferrer"><span>Twitch</span> @ekoyildiz ↗</a></article><article class="social-group"><small>📺 VİDEO</small><h3>YouTube & TikTok</h3><a class="social-link" href="https://www.youtube.com/@eko8yildiz" target="_blank" rel="noreferrer"><span>YouTube Ana</span> @eko8yildiz ↗</a><a class="social-link" href="https://www.youtube.com/@eko8yildiz2" target="_blank" rel="noreferrer"><span>YouTube Yan</span> @eko8yildiz2 ↗</a><a class="social-link" href="https://www.tiktok.com/@kimdirbueko" target="_blank" rel="noreferrer"><span>TikTok</span> @kimdirbueko ↗</a></article><article class="social-group"><small>📸 GÜNLÜK PAYLAŞIMLAR</small><h3>Instagram</h3><a class="social-link" href="https://www.instagram.com/ekonqt/" target="_blank" rel="noreferrer"><span>Eko</span> @ekonqt ↗</a><a class="social-link" href="https://www.instagram.com/egee7dino/" target="_blank" rel="noreferrer"><span>Ege</span> @egee7dino ↗</a><p style="margin:17px 0 0;color:var(--muted);font-size:.82rem">Bildirimleri açmayı unutma. İyi ki varsın. ❤️</p></article></div></section>
      <section class="home-join"><div><h2>Toplulukta yerini al.</h2><p>EkoYıldız veya RobloxLand Discord sunucusuna katıl; duyuruları ve desteği kaçırma.</p></div><div class="home-actions" style="margin:0"><a class="home-button home-button-light" href="https://discord.gg/rEu5gvRBdM" target="_blank" rel="noreferrer">EkoYıldız Discord</a><a class="home-button home-button-light" href="https://discord.gg/tfykdvvdPT" target="_blank" rel="noreferrer">RobloxLand Discord</a></div></section>
    </main>
  </div>${renderPlatformFooter({ theme: 'light' })}${renderSearchDialog({ theme: 'light' })}<script>const starButton=document.getElementById('star-button');let stars=0;starButton?.addEventListener('click',e=>{stars++;for(let i=0;i<7;i++){const s=document.createElement('span');s.className='floating-star';s.textContent='✦';s.style.left=(e.clientX+(Math.random()*70-35))+'px';s.style.top=(e.clientY+(Math.random()*30-15))+'px';s.style.setProperty('--x',(Math.random()*140-70)+'px');document.body.appendChild(s);setTimeout(()=>s.remove(),950)}if(stars===5){starButton.title='EkoYıldız modu açık ✦';starButton.textContent='★';}});document.querySelector('.platform-brand')?.addEventListener('dblclick',()=>{document.body.style.background='#fff8fa';setTimeout(()=>document.body.style.background='',900)});</script>${platformChromeScript()}
</body></html>`;
}
...
function renderMainHomePage(userOrOptions = null) {
  ...
  const youtubeSpotlight = `<section class="home-section"><div class="home-section-head"><h2>YouTube’dan öne çıkanlar</h2><p>Son videoyu aç, serilere göz at ve tüm yayın arşivini Video Blog’dan keşfet.</p></div><div class="home-grid"><article class="home-card"><small>SON YÜKLENEN</small><h3>Nasıl Kamp Kurulur #2</h3><p>Kampların neden zorlandığını ve daha düzenli bir topluluk nasıl kurulur, videoda incele.</p><a href="/video-blog">Son videoyu incele →</a></article><article class="home-card"><small>SERİLER</small><h3>Ekocast ve Tüm Gerçekler</h3><p>Röportajlar, topluluk hikâyeleri ve Roblox dünyasından seçilmiş içerikler.</p><a href="/video-blog">Postları ve videoları incele →</a></article><article class="home-card"><small>RESMÎ KANAL</small><h3>Yeni videoları kaçırma</h3><p>Abone ol; yeni yayın, video ve topluluk duyuruları ilk sana ulaşsın.</p><a href="https://www.youtube.com/@eko8yildiz" target="_blank" rel="noreferrer">Kanala git ↗</a></article></div></section>`;
  return page.replace('</main>', `${youtubeSpotlight}</main>`).replace('</body>', `${liveStatsScript}</body>`);
