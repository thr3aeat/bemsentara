...
const CHANNELS = {
  ...
  TERFI_LOG: '1518693000270844079', // where promotions are announced
  ...
  try {
    ...
    if (guild && member) {
      ...
      const ALL_MANAGED_ROLES = [
        ...
        '1517656567481372772', // Seviye 5 özel rolü (Moderatör sunucusu)
        '1517695716594683904', // Seviye 6 özel rolü (Moderatör sunucusu)
