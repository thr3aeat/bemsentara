...
const GUILD2_VOICE_CATEGORY_ID = process.env.GUILD2_VOICE_CATEGORY_ID || "1518692429841043750";
...
/** Modların ceza kayıtları log kanalı */
const EKOYILDIZ_MOD_CEZA_LOG_CHANNEL_ID = process.env.EKOYILDIZ_MOD_CEZA_LOG_CHANNEL_ID || "1518693023934844959";
/** Mod işlem log kanalı (ModLog) */
...
/** EkoYıldız Video Ekibi Rolü */
const EKOYILDIZ_VIDEO_EKIBI_ROLE_ID = process.env.EKOYILDIZ_VIDEO_EKIBI_ROLE_ID || "1546577772724359239";
...
module.exports = {
  ...
  EKOYILDIZ_MOD_CEZA_LOG_CHANNEL_ID,
  EKOYILDIZ_MOD_LOG_CHANNEL_ID,
  // EkoYıldız Oyun Kanalları
