...
const staffProgressSchema = new mongoose.Schema({
  ...
  gamification: {
    ...
    claimedSpecialDayBonuses: { type: [String], default: [] }, // Önemli gün ikramiyesi alınan günler [Key]
  },
  ...
  insuranceActiveUntil: { type: Date, default: null },
  vipThemeUnlocked: { type: Boolean, default: false },
  vipBadgeUnlocked: { type: Boolean, default: false },
  ...
  restaurantOrders: { type: Number, default: 0 },  // Moderatör Restorantı - Yapılan Sipariş Sayısı
